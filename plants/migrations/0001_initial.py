# Generated by Django 3.0.5 on 2020-05-23 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='Name')),
                ('description', models.CharField(blank=True, default='', max_length=150, verbose_name='Description')),
                ('exposure', models.CharField(choices=[('dark', 'Dark'), ('shade', 'Shade'), ('partsun', 'Part sun'), ('fullsun', 'Full sun')], max_length=10, verbose_name='Exposure')),
